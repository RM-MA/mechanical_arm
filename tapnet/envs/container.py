...
class Container(object):
    ...
    def add_new_box(self, box, ems_id=0, corner_id=0, is_rotate=False, real_pos=None, allow_unstable=False, box_id=0):
        ...
        if pos is not None:
            if len(self.each_space) != 0:
                is_stable = self.each_space[container_id].drop_box([bx,by,bz], [lx,ly], False, 1, 1, allow_unstable, same_height_threshold = self.same_height_threshold)
    ...
    def update_heightmap(self, container_id, same_height_threshold):
