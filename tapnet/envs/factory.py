...
class Factory(object):
    def __init__(self, fact_type, data_type, targe_container_size=None, gripper_width=10, require_box_num=None, data_folder=None, simulation_scene=None) -> None:
        '''
        fact_type: string { 'box', 'tap_fake', 'tap_sim', 'conveyor_fake', 'conveyor_sim' }
        ...
        assert fact_type in [ 'box', 'tap_fake', 'tap_sim', 'conveyor_fake', 'conveyor_sim' ], "fact_type only support { 'box', 'tap_fake', 'tap_sim', 'conveyor_fake', 'conveyor_sim' }"
